...
plot(t, omegaLog(:,1))
hold on
plot(t, omegaLog(:,2), '--', 'LineWidth', 1.5)
...
save('dynamicModelResults.mat', 't_ode', 'C_zCoords_ode', ...
    'omegaKnee_ode', 'currentLog_ode');
